...
export const Main = () => {
  const { completed, user, getAuthenticationState } = useAuthentication()
  ...
  useEffect(() => {
    if (completed && (!user || !validEmail(user.email))) {
      //&& tab !== WEBUI_TABS.authenticate) {
